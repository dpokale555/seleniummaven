...
public class Create_NewStore {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[@class='p-treenode-content p-treenode-selectable p-highlight']//span[@class='ng-star-inserted'][normalize-space()='Merchant1212']")).click();
